        ...
        <div class="col-lg-12">
            ...
            <div class="row">
                <?php if ($this->input->post('district')) : ?>
                    ...
                    &nbsp;&nbsp;
                    <a href="<?php echo base_url() ?>data/country_csv_data/1" class="btn bt-sm bg-gray-dark color-pale" style="width:100px;"><i class="fa fa-file-excel" aria-hidden="true"></i>CSV</a>
                    &nbsp;&nbsp;
                <?php endif; ?>
